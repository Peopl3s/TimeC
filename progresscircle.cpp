...
{
  //  QPixmap pp=QPixmap("D:\\basic1-014_stopwatch-512.png").scaled(50,50,Qt::IgnoreAspectRatio);
    ...
    painter.setRenderHint(QPainter::TextAntialiasing, true); //QPainter::Antialiasing
    QRect rr(25,25,50,50);
 //   painter.drawPixmap(rr,pp);
    ...
    painter.setPen(QPen(this->color(), 1, Qt::SolidLine, Qt::RoundCap));
    painter.setFont(QFont("Times",8,QFont::Bold));
    painter.drawText(rr,s,QTextOption(Qt::AlignCenter));
